...
class ListOrderedComponent extends QuillComponentBuilder {
  ...
  QuillComponentWidget build(QuillComponentContext componentContext) {
    return ListOrderedComponentWidget(
...
class ListOrderedComponentWidget extends QuillComponentStatefulWidget {
  const ListOrderedComponentWidget({
  ...
  @override
  State<ListOrderedComponentWidget> createState() =>
      _ListOrderedComponentState();
}

class _ListOrderedComponentState extends State<ListOrderedComponentWidget>
    with
        SelectableMixin<ListOrderedComponentWidget>,
        DefaultSelectableMixin<ListOrderedComponentWidget> {
  @override
