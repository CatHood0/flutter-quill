...
class ListUnorderedComponent extends QuillComponentBuilder {
  ...
  QuillComponentWidget build(QuillComponentContext componentContext) {
    return ListUnorderedComponentWidget(
...
class ListUnorderedComponentWidget extends QuillComponentStatefulWidget {
  const ListUnorderedComponentWidget({
  ...
  @override
  State<ListUnorderedComponentWidget> createState() =>
      _ListUnorderedComponentState();
}

class _ListUnorderedComponentState extends State<ListUnorderedComponentWidget>
    with
        SelectableMixin<ListUnorderedComponentWidget>,
        DefaultSelectableMixin<ListUnorderedComponentWidget> {
  @override
